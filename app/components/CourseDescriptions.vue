<template>
    <div class="course-detail flex justify-beetween gap-28">
        <div class="flex flex-col gap-6">
            <h2 class="text-4xl font-bold">{{ title }}</h2>

            <p class="line-clamp-2">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان گرافیک است، چاپگرها و متون
        ...
        <video class="w-[480px] h-full rounded-md" controls>
